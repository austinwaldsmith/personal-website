...
function delay(n) {
  ...
  function pageTransition1() {
    ...
    tl.to('.load-text1', { duration: 1, opacity: 1, translateX: 20});
  ...
  function pageTransition2() {
    ...
    tl.set('.loading-screen', { transformOrigin: "bottom left"});
    tl.to('.loading-screen', { duration: .5, scaleX: 1});
    tl.to('.load-text2', { duration: 1, opacity: 1, translateX: 20});
  ...
  function pageTransition3() {
    ...
    tl.set('.loading-screen', { transformOrigin: "bottom left"});
    tl.to('.loading-screen', { duration: .5, scaleX: 1});
    tl.to('.load-text3', { duration: 1, opacity: 1, translateX: 20});
  ...
  function pageTransition4() {
    ...
    tl.set('.loading-screen', { transformOrigin: "bottom left"});
    tl.to('.loading-screen', { duration: .5, scaleX: 1});
    tl.to('.load-text4', { duration: 1, opacity: 1, translateX: 20});
